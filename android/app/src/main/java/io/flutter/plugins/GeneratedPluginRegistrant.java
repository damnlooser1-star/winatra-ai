...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.theorangeshade.onenm_local_llm.OnenmLocalLlmPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin onenm_local_llm, com.theorangeshade.onenm_local_llm.OnenmLocalLlmPlugin", e);
    }
    try {
